...
Copyright (c) 2014 SHACoin Developers
...
Intro
-----
SHACoin is a free open source project derived from PPCoin, with
...
After completing windows setup then run windows command line (cmd)
  cd daemon
  SHACoind
You would need to create a configuration file SHACoin.conf in the default
wallet directory. Grant access to SHACoind.exe in anti-virus and firewall
...
SHACoind backupwallet <destination_backup_file>
Then shutdown ppcoind by
SHACoind stop
Start up the new SHACoind (0.3.0).
